export default function buildmakeSendElectronicTicket({
  registerFont,
  canvasLoader,
  imageLoader,
  barcodeWriter,
  ...
  return async function makeSendElectronicTicket(ticket, reservation, seatMapInfo) {
    ...
    electronicTicket.drawImage(pp, 250, 740)
